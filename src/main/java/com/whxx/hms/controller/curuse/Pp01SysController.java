...
public class Pp01SysController extends BaseController {
	
	private static String PREFIX = "/hotel/pp02/";
    ...
    */
    ...
    public Object list(HttpServletRequest reuqest,HttpServletResponse response) {
    	...
    	List<Map> list = pp01Srv.selectPp01ByPageSys(param);
    ...
    public Tip add(@RequestBody Tbpp01 pp01, BindingResult result) {
        ...
        pp01Srv.insertTbpp01Sys(setCreateEmpAndTime(pp01));
        return SUCCESS_TIP;
    }
