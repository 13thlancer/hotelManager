...
import com.whxx.core.exception.ToolBoxException;
import com.whxx.core.kit.CollectionKit;
import com.whxx.core.kit.HexKit;
...
public class Convert {
	 ...
	 * 转百分数
	 */
	public static String getPercent(int i, int j) {
		DecimalFormat percent = new DecimalFormat("##%");// 计算百分比

		Double num = (double) i / (double) j;
		String format = percent.format(num);
		return format;
	}
}
